...
namespace EnergyManagerWebApp.emAPIService {
    ...
    public interface IemAPI {
        ...
        string createInvoice(int meterId, string billDate, string startDate, string endDate, int kWh, double consumptionCharge, double standingCharge, double otherCharge, int propertyId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IemAPI/getPeriods", ReplyAction="http://tempuri.org/IemAPI/getPeriodsResponse")]
        string getPeriods();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IemAPI/getMostRecentDate", ReplyAction="http://tempuri.org/IemAPI/getMostRecentDateResponse")]
        string getMostRecentDate(int propertyId, int dataTypeId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IemAPI/getFloorArea", ReplyAction="http://tempuri.org/IemAPI/getFloorAreaResponse")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IemAPIChannel : EnergyManagerWebApp.emAPIService.IemAPI, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IemAPIClient : System.ServiceModel.ClientBase<EnergyManagerWebApp.emAPIService.IemAPI>, EnergyManagerWebApp.emAPIService.IemAPI {
        ...
        public string editMeterReading(int readingId, int meterId, string newMeter, int propertyId) {
            return base.Channel.editMeterReading(readingId, meterId, newMeter, propertyId);
        }
        
        public string deleteMeter(int meterId, int propertyId) {
            return base.Channel.deleteMeter(meterId, propertyId);
        }
        
        public string deleteReading(int readingId, int meterId, int propertyId) {
            return base.Channel.deleteReading(readingId, meterId, propertyId);
        }
        ...
        public string createInvoice(int meterId, string billDate, string startDate, string endDate, int kWh, double consumptionCharge, double standingCharge, double otherCharge, int propertyId) {
            return base.Channel.createInvoice(meterId, billDate, startDate, endDate, kWh, consumptionCharge, standingCharge, otherCharge, propertyId);
        }
        
        public string editInvoice(int invoiceId, string newInvoice, int propertyId) {
            return base.Channel.editInvoice(invoiceId, newInvoice, propertyId);
        }
        
        public string deleteInvoice(int invoiceId, int propertyId) {
            return base.Channel.deleteInvoice(invoiceId, propertyId);
        }
        ...
        public string getMostRecentDate(int propertyId, int dataTypeId) {
            return base.Channel.getMostRecentDate(propertyId, dataTypeId);
        }
        
        public string getFloorArea(int propertyId) {
            return base.Channel.getFloorArea(propertyId);
        }
